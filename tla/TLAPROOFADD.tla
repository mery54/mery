...
Init ==  x=x0 /\ y =y0 /\ z = 0 /\ ok=0 
Next == evt1 \/ evt2 \/ evt3  \/ UNCHANGED <<x,y,z,ok>>
vars == <<x,y,z,ok>>
...
ASSUME  InductiveInvariant, evt1
  PROVE  i1'
BY SMT  DEFS  InductiveInvariant, evt1, i1,i2,i3,i4,i5,pre,typeInt,B,typeB


LEMMA evt1po2 ==
ASSUME  InductiveInvariant, evt1
  PROVE  i2'
BY  DEFS InductiveInvariant, evt1,i1,i2,i3,i4,i5,pre,typeInt,typeB
...
ASSUME  InductiveInvariant, evt1
  PROVE  i4'
BY SMT DEFS InductiveInvariant, evt1,i1,i2,i3,i4,i5,pre,typeInt,typeB
...
ASSUME  InductiveInvariant, evt1
  PROVE  i5'
BY  DEFS InductiveInvariant, evt1,i1,i2,i3,i4,i5,pre,typeInt,B, typeB
